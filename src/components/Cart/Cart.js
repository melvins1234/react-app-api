    ...
    return ( 
        ...
        <div className="cart-section__table-row" id="beats__dbdbdb.png"><div className="cart-section__table-row--product">
            ...
            <div className="cart-section__table-row--qty">
                <button className="cart-section__table-row--qty--minus-btn" id="qty-minus-btn">-</button>
                <div className="cart-section__table-row--qty--number">3</div>
                <button className="cart-section__table-row--qty--plus-btn" id="qty-plus-btn">+</button>
            </div>
            <div className="cart-section__table-row--price">
                <span className="cart-section__table-row--price--label">Price</span>
                <span className="cart-section__table-row--price--label-price">$8997</span>
            </div></div></div>

        <div className="cart-section__bottom">
            <div className="cart-section__bottom__voucher">
                <input type="text" defaultValue="Voucher code" />
                <button className="cart-section__bottom__voucher--redeem-btn">Redeem</button>
            </div>
            <div className="cart-section__bottom__total-table">
                ...
                <div className="cart-section__bottom__total-table--check-out">
                    <button className="cart-section__bottom__total-table--check-out--btn">Check Out</button>
                </div>
            </div>
        </div>
    </section>
